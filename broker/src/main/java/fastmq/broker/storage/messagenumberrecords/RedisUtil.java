package fastmq.broker.storage.messagenumberrecords;
...
/**
 * 此类是操作redis的技术类，基于两个redis hash表 records:message_num ,records:commit_num
 * 分别记录以topic_partition为key的vaule值：消息计数，已消费消息计数，用以查询和自增。
 */
@Service(value = "redis")
public class RedisUtil implements RecordsUtil {
  ...
  public String selectMessageNumByKeyAndUpdateNum(String topic_partition, String H)
      throws Exception {
